...
export const generateStaticFiles = async (
  ...
  if (!payload.singleFile) {
    for (const key in manifest) {
      ...
      const filePath = require.resolve(join("@allurereport/web-classic/dist", singleFile ? "single" : "multi", key));
    ...
    const mainJsSource = require.resolve("@allurereport/web-classic/dist/single/main.js");
