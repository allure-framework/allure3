...
export const InspectorTab: React.FunctionComponent<{
  ...
  const onAriaEditorChange = React.useCallback(
    (ariaSnapshot: string) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ height: 50 }}>
        <CodeMirrorWrapper
          text={highlightedElement.locator || ""}
