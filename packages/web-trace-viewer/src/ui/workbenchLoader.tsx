...
import { TestServerConnection, WebSocketTestServerTransport } from "@/utils/isomorphic/testServerConnection";
import { LLMProvider } from "./llm.js";
import { MultiTraceModel } from "./modelUtil.js";
import { SettingsToolbarButton } from "./settingsToolbarButton.js";
...
export const WorkbenchLoader: React.FunctionComponent<{}> = () => {
  ...
  const showFileUploadDropArea = !!(
    !isServer &&
    !dragOver &&
    !fileForLocalModeError &&
    (!traceURLs.length || processingErrorMessage)
  );
      ...
      {fileForLocalModeError && (
        <div className="drop-target">
          ...
          <div style={{ paddingTop: 20 }}>
            <div>
              1. Click <a href={fileForLocalModeError}>here</a> to put your trace into the download shelf
            </div>
            <div>
              2. Go to <a href="https://trace.playwright.dev">trace.playwright.dev</a>
            </div>
