...
import { generateCurlCommand, generateFetchCall } from "@/third_party/devtools.js";
...
import { getAPIRequestCodeGen } from "./codegen.js";
...
const RequestTab: React.FunctionComponent<{
    ...
    const readResources = async () => {
      if (resource.request.postData) {
        ...
        if (resource.request.postData._sha1) {
          ...
          setRequestBody({
            text: formatBody(await response.text(), requestContentType),
  ...
  return (
    <div className="network-request-details-tab">
...
const FontPreview: React.FunctionComponent<{
  ...
  return (
    <div className="network-font-preview">
      ABCDEFGHIJKLM
      <br />
      NOPQRSTUVWXYZ
      <br />
