...
import { addThemeListener, currentTheme, removeThemeListener } from "@/ui/theme.js";
import { useMeasure } from "@/utils/ui.js";
import type { XtermModule } from "./xtermModule.js";
...
export const XtermWrapper: React.FC<{ source: XtermDataSource }> = ({ source }) => {
  const [measure, xtermElement] = useMeasure<HTMLDivElement>();
  const [theme, setTheme] = React.useState(currentTheme());
  const [modulePromise] = React.useState<Promise<XtermModule>>(import("./xtermModule.js").then((m) => m.default));
