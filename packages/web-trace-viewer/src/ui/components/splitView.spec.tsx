...
test("should render", async ({ mount }) => {
  const component = await mount(
    <SplitView
      sidebarSize={100}
      main={
        <div id="main" style={{ border: "1px solid red", flex: "auto" }}>
          main
        </div>
      }
      sidebar={
        <div id="sidebar" style={{ border: "1px solid blue", flex: "auto" }}>
          sidebar
        </div>
      }
    />,
...
test("should render sidebar first", async ({ mount }) => {
  const component = await mount(
    <SplitView
      ...
      sidebarIsFirst
      main={
        <div id="main" style={{ border: "1px solid blue", flex: "auto" }}>
          main
        </div>
      }
      sidebar={
        <div id="sidebar" style={{ border: "1px solid red", flex: "auto" }}>
          sidebar
        </div>
      }
    />,
