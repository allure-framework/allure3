...
import type { ContextEntry } from "@/types/entries.js";
import type { Entry } from "@/types/har";
import { GridView, type RenderedGridCell } from "@/ui/components/gridView";
import { SplitView } from "@/ui/components/splitView";
import type { Language } from "@/utils/locatorGenerators.js";
import { bytesToString, msToString } from "@/utils/ui";
import type { Boundaries } from "./geometry.js";
import { type MultiTraceModel, context } from "./modelUtil.js";
import { type FilterState, NetworkFilters, type ResourceType, defaultFilterState } from "./networkFilters.js";
import { NetworkResourceDetails } from "./networkResourceDetails.js";
...
export const NetworkTab: React.FunctionComponent<{
  ...
  const { renderedEntries } = React.useMemo(() => {
    const renderedEntries = networkModel.resources
      .map((entry) => renderEntry(entry, boundaries, networkModel.contextIdMap))
      .filter(filterEntry(filterState));
    if (sorting) {
        ...
        <SplitView
          ...
          main={
            <NetworkResourceDetails
              ...
              startTimeOffset={selectedEntry.start}
