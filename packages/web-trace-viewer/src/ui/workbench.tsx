...
import type { Entry } from "@/types/har.js";
import type { AfterActionTraceEventAttachment } from "@/types/trace.js";
import { SplitView } from "@/ui/components/splitView";
import { TabbedPane } from "@/ui/components/tabbedPane";
import type { TabbedPaneTabModel } from "@/ui/components/tabbedPane";
import { ToolbarButton } from "@/ui/components/toolbarButton";
import { clsx, msToString, useSetting } from "@/utils/ui";
import { ActionList } from "./actionList.js";
import { AnnotationsTab } from "./annotationsTab.js";
import { AttachmentsTab } from "./attachmentsTab.js";
import { CallTab } from "./callTab.js";
import type { ConsoleEntry } from "./consoleTab.js";
import { ConsoleTab, useConsoleTabModel } from "./consoleTab.js";
import { ErrorsTab, useErrorsTabModel } from "./errorsTab.js";
import type { ErrorDescription } from "./errorsTab.js";
...
import type * as modelUtil from "./modelUtil.js";
import { NetworkTab, useNetworkTabModel } from "./networkTab.js";
import { SnapshotTabsView } from "./snapshotTab.js";
import type { HighlightedElement } from "./snapshotTab.js";
import { SourceTab } from "./sourceTab.js";
import { testStatusIcon, testStatusText } from "./testUtils.js";
import type { UITestStatus } from "./testUtils.js";
...
export const Workbench: React.FunctionComponent<{
  ...
  const [revealedAttachment, setRevealedAttachment] = React.useState<
    [attachment: AfterActionTraceEventAttachment, renderCounter: number] | undefined
  >(undefined);
  ...
  const [selectedPropertiesTab, setSelectedPropertiesTab] = useSetting<string>(
    "propertiesTab",
    showSourcesFirst ? "source" : "call",
  );
  ...
  const setHighlightedAction = React.useCallback(
    (highlightedAction: modelUtil.ActionTraceEventInContext | undefined) => {
  ...
  const selectPropertiesTab = React.useCallback(
    (tab: string) => {
  ...
  const setIsInspecting = React.useCallback(
    (value: boolean) => {
  ...
  const elementPicked = React.useCallback(
  ...
  const revealAttachment = React.useCallback(
    (attachment: AfterActionTraceEventAttachment) => {
  ...
  let fallbackSourceErrorCount: number | undefined;
  ...
  const networkTab: TabbedPaneTabModel = {
    ...
    render: () => (
      <NetworkTab
        ...
        onEntryHovered={setHighlightedEntry}
        sdkLanguage={model?.sdkLanguage ?? "javascript"}
      />
    ),
  };
  ...
  const actionsTab: TabbedPaneTabModel = {
    ...
    component: (
      <div className="vbox">
        {status && (
          <div className="workbench-run-status">
