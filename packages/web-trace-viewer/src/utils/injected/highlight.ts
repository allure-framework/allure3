...
import { stringifySelector } from "@/utils/selectorParser";
import type { ParsedSelector } from "@/utils/selectorParser";
...
export class Highlight {
  ...
  runHighlightOnRaf(selector: ParsedSelector) {
    ...
    this.updateHighlight(
      this._injectedScript.querySelectorAll(selector, this._injectedScript.document.documentElement),
