 ...
 */
import type { TestServerInterface, TestServerInterfaceEvents } from "@/utils/isomorphic/testServerInterface";
...
export class TestServerConnection implements TestServerInterface, TestServerInterfaceEvents {
  ...
  private _dispatchEvent(method: string, params?: any) {
    ...
    else if (method === "testFilesChanged") this._onTestFilesChangedEmitter.fire(params);
    else if (method === "loadTraceRequested") this._onLoadTraceRequestedEmitter.fire(params);
  }
