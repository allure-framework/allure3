 ...
 */
import { splitProgress } from "./progress.js";
import { unwrapPopoutUrl } from "./snapshotRenderer.js";
import { SnapshotServer } from "./snapshotServer.js";
import { TraceModel } from "./traceModel.js";
import { FetchTraceModelBackend, TraceViewerServer, ZipTraceModelBackend } from "./traceModelBackends.js";
import { TraceVersionError } from "./traceModernizer.js";
...
async function loadTrace(
  ...
  try {
    ...
    const backend = traceUrl.endsWith("json")
      ...
      : new ZipTraceModelBackend(traceUrl, data.traceViewerServer, fetchProgress);
