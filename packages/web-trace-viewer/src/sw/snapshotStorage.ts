...
import type { FrameSnapshot, ResourceSnapshot } from "@/types/snapshot";
import { LRUCache } from "./lruCache.js";
import { SnapshotRenderer, rewriteURLForCustomProtocol } from "./snapshotRenderer.js";

export class SnapshotStorage {
  private _frameSnapshots = new Map<
    string,
    {
      raw: FrameSnapshot[];
