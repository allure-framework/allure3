...
export interface TestType<TestArgs extends {}, WorkerArgs extends {}> {
  ...
  step: {
     ...
     * @param body Step body.
     * @param options
     */<T>(title: string, body: (step: TestStepInfo) => T | Promise<T>, options?: {
      box?: boolean;
      location?: Location;
      timeout?: number;
    }): Promise<T>;
     ...
     * @param options
     */
    skip(title: string, body: (step: TestStepInfo) => any | Promise<any>, options?: {
      box?: boolean;
      location?: Location;
      timeout?: number;
    }): Promise<void>;
...
type AllowedGenericMatchers<R, T> =
  PlaywrightTest.Matchers<R, T>
  & Pick<GenericAssertions<R>, "toBe" | "toBeDefined" | "toBeFalsy" | "toBeNull" | "toBeTruthy" | "toBeUndefined">;
...
export type Expect<ExtendedMatchers = {}> = {
  ...
  soft: <T = unknown>(actual: T, messageOrOptions?: string | {
    message?: string;
  }) => MakeMatchers<void, T, ExtendedMatchers>;
...
interface LocatorAssertions {
   ...
   * @param options
   */
  toContainText(expected: string | RegExp | readonly (string | RegExp)[], options?: {
    /**
   ...
   * @param options
   */
  toHaveClass(expected: string | RegExp | readonly (string | RegExp)[], options?: {
    /**
     * Time to retry the assertion for in milliseconds. Defaults to `timeout` in `TestConfig.expect`.
     */
    timeout?: number;
   ...
   * @param options
   */
  toHaveScreenshot(name: string | readonly string[], options?: {
    /**
   ...
   * @param options
   */
  toHaveText(expected: string | RegExp | readonly (string | RegExp)[], options?: {
    /**
     * Whether to perform case-insensitive match.
   ...
   * @param options
   */
  toHaveValues(values: readonly (string | RegExp)[], options?: {
    /**
     * Time to retry the assertion for in milliseconds. Defaults to `timeout` in `TestConfig.expect`.
     */
    timeout?: number;
...
interface PageAssertions {
   ...
   * @param options
   */
  toHaveScreenshot(name: string | readonly string[], options?: PageAssertionsToHaveScreenshotOptions): Promise<void>;
...
interface SnapshotAssertions {
   ...
   * @param options
   */
  toMatchSnapshot(name: string | readonly string[], options?: {
    /**
     * An acceptable ratio of pixels that are different to the total amount of pixels, between `0` and `1`. Default is
     * configurable with `TestConfig.expect`. Unset by default.
     */
...
export interface TestInfo {
   ...
   */
  outputPath(...pathSegments: readonly string[]): string;
   ...
   */
  snapshotPath(...pathSegments: readonly string[]): string;
