import type { AllureStore, EnvironmentItem } from "@allurereport/core-api";
import { type Plugin, type PluginContext, preciseTreeLabels } from "@allurereport/plugin-api";
