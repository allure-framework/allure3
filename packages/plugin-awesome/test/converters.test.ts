...
describe("convertTestResult", () => {
  ...
  it("hides labels by exact string matcher", () => {
    const result = convertTestResult(
      createTestResult({
        labels: [
          { name: "owner", value: "qa" },
  ...
  it("hides labels by regexp matcher", () => {
    const result = convertTestResult(
      createTestResult({
        labels: [
          { name: "owner", value: "qa" },
  ...
  it("handles stateful regexp matchers deterministically", () => {
  ...
  it("hides fallback testCaseId label by default", () => {
    const result = convertTestResult(
      createTestResult({
        labels: [
  ...
  it("hides underscore-prefixed labels by default", () => {
    const result = convertTestResult(
      createTestResult({
        labels: [
  ...
  it("keeps non-hidden labels when hideLabels is configured", () => {
    const result = convertTestResult(
      createTestResult({
        labels: [
          { name: "owner", value: "qa" },
    ...
    expect(result.labels).toEqual([{ name: "severity", value: "critical" }]);
    expect(result.groupedLabels.severity).toEqual(["critical"]);
  });
});
