...
export const createLeafLocalizer = (t: (data: string) => string) => (leaf: AwesomeTreeLeaf): AwesomeTreeLeaf => ({
    ...leaf,
    transitionText: t(leaf.transition),
});

export const createTreeLocalizer = (t: (data: string) => string) => (tree: RecursiveTree): RecursiveTree => ({
    ...tree,
