...
export const shortcutGroups: ShortcutGroup[] = [
  {
    ...
    items: [
      ...
      { binding: { key: "3" }, labelKey: "items.reportTabResolutionCategories" },
  ...
  },
  {
    ...
    items: [
      ...
      { binding: { key: "4" }, labelKey: "items.tabRetries" },
      { binding: { key: "5" }, labelKey: "items.tabAttachments" },
      { binding: { key: "6" }, labelKey: "items.tabEnvironments" },
