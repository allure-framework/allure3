        ...
        renderData={(data) => {
          ...
          for (const [key, value] of Object.entries(data)) {
            ...
            if (key === "pie" && isStatistic(value)) {
              chartItems.push({
                id: "current-status",
                chart: { type: ChartType.CurrentStatus, data: value, title: "" },
              });
              ...
              summaryCards.push(
                <GridItem key="summary-duration" className={styles["overview-grid-item"]}>
                  <div className={styles["overview-summary-card"]}>
                    <Text tag="div" type="ui" size="s" className={styles["overview-summary-label"]}>
                      {t("totalDuration")}
                    </Text>
                    <Text tag="div" size="l" bold className={styles["overview-summary-value"]}>
          ...
          const charts = chartItems.map(({ id, chart }) => {
            const chartWidget = getChartWidgetByType(chart, { t, empty });
            return (
