...
const ATTACHMENT_RESOURCE_PATH_PREFIX = "data/attachments/";

// Attachment resource URLs are generated by the report and intentionally remain report-local.
const attachmentUrl = (attachment: Attachment) => `${ATTACHMENT_RESOURCE_PATH_PREFIX}${attachment.source}`;
