...
const createScreenDiffView = (options: ScreenDiffOptions) => {
  ...
  Object.assign(el, {
    render() {
      ...
      el.replaceChildren(
        ...
        createElement("div", {
          ...
          children: [
            ...
            renderDiffContent(diffType, options.diffImage, options.actualImage, options.expectedImage),
          ],
        }),
      );
      ...
      const activeSwitcher = el.querySelector(`[name="${radioName}"][value="${diffType || "diff"}"]`);
