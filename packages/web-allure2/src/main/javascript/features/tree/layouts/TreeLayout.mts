...
const isSameTreeNode = (left: TreeRouteNode | null | undefined, right: TreeRouteNode | null | undefined) =>
...
export default function TreeLayout(
  ...
  return AppLayout({
    ...
    onViewReady: () => {
      onRouteUpdate(options.testGroup || null, options.testResult || null, options.testResultTab || null);
    },
    onRouteUpdate,
  });
}
