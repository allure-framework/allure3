...
import { graphTab, overviewTab, widgetsByTab as overviewWidgets } from "../../features/overview/index.mts";
...
type RegisterTabRoutesOptions = {
  notFound: () => Mountable;
  router: AppRouter;
  showView: <TArgs extends RouteArguments>(factory: (...args: TArgs) => Mountable) => (...args: TArgs) => void;
};
...
export const getTestResultBlocks = (position: TestResultBlockPosition) => blocksByPosition[position] || [];
