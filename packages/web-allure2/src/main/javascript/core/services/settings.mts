...
const globalSettingsDefaults: Pick<GlobalSettingsAttributes, "sidebarCollapsed" | "sideBySidePosition"> = {
...
export const getSettingsForTreePlugin = (pluginName: string, defaults: TreeSettingsAttributes = treePluginDefaults) => {
