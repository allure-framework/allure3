...
export default class BaseElement extends HTMLElement {
  ...
  private mountedChildren: Map<string, { container: Element; mountable: import("../view/types.mts").Mountable }>;
  ...
  getMountedChild<TMountable extends import("../view/types.mts").Mountable = import("../view/types.mts").Mountable>(
    name: string,
  ) {
