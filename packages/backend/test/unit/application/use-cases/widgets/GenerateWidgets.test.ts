...
import { GenerateWidgets } from '../../../../../src/application/use-cases/widgets/GenerateWidgets.js';
...
describe('GenerateWidgets', () => {
  ...
  beforeEach(() => {
    ...
    useCase = new GenerateWidgets(mockLaunchRepository, mockTestResultRepository, pluginService);
  });

  it('should generate widgets for launch', async () => {
